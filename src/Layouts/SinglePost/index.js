      ...
      <Center>
        <Actionsheet isOpen={isOpen} onClose={onClose}>
          <Actionsheet.Content>
            ...
            <Actionsheet.Item>دانلود فایل </Actionsheet.Item>
            <Actionsheet.Item>اشتراک گذاری</Actionsheet.Item>
            <Actionsheet.Item>افزودن به مورد علاقه ها</Actionsheet.Item>
            <Actionsheet.Item>بستن</Actionsheet.Item>
          </Actionsheet.Content>
        </Actionsheet>
      </Center>
      <Image
